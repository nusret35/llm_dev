...
class Solution:
    ...
    def generate_insights(self, user_persona, user_purpose):
       ...
       # Extracting section texts of important sections 
        ...
        insights = self.extractor_70B_model.extract_insights(section_input_abstract, self.max_tokens, user_persona, user_purpose)
