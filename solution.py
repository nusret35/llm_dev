...
class Solution:
    ...
    def _preprocess_insights(self, insights):
    ...
    def _preprocess_image_exp(self, explanations):
        # Find the position of the last dot in the string
    ...
    def _generate_insights(self, section_summary, user_persona, user_purpose, regeneration, reason_for_regeneration):
        ...
        insights = self._preprocess_insights(insights)
    ...
    def _generate_image_explanations(self, insights, user_persona, user_purpose):  
        ...
        important_images = self._preprocess_image_exp(important_images)
    ...
    async def solution_pipeline(self, send_message=None):
        ...
        important_images_explanation, image_title_pairs = self._generate_image_explanations(insights, user_persona, user_purpose)
        found_images = self._display_images(important_images_explanation, image_title_pairs)
