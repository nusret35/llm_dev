...
class New_Solution:
    ...
    def _generate_title(self, insights, user_persona, user_purpose):
        ...
        title = self.langchain_extractor_13B_model.generate_title(insights, user_persona, user_purpose)
        print("\nTitle:\n" + title)
        return title
    ...
    def _generate_image_explanations(self, insights, user_persona, user_purpose):  
        ...
        important_images = self.stream_generator_13B_model.choose_images(insights, image_titles, user_persona, user_purpose)
