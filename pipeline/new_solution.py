...
class NewSolution:
    def __init__(self, pdf_path=None, pdf_file_bytes=None):
        ...
        extractor_dict, self.max_tokens = configure_models(self.greenness_input)

        self.langchain_extractor_70B_model = extractor_dict["llama_70B"] 
        self.langchain_extractor_13B_model = extractor_dict["llama_13B"]
        self.langchain_extractor_mistral = extractor_dict["mistral"]
    ...
    def generate_summary(self):
        ...
        for section_name, section_text in critical_section_information.items():
            if section_text != "":
                print("\nSummary is generated by embeddings...")
    ...
    def generate_insights(self, section_summary, user_persona, user_purpose, regeneration, reason_for_regeneration, callback=None):
        ...
        insights = self.langchain_extractor_mistral.extract_insights(section_summary, user_persona, user_purpose, regeneration, reason_for_regeneration,callback=callback)
    ...
    def generate_title(self, insights, user_persona, user_purpose,callback=None):
        ...
        response = self.langchain_extractor_mistral.generate_title(insights, user_persona, user_purpose, callback=callback)
    ...
    def close_models(self):
        ...
        self.langchain_extractor_mistral.close()