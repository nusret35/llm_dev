...
main_prompt = '"You are a tool that enriches the abstract by giving insights from the sections of introduction, conclusion, methodoly, and outcomes. As an output, you give an enriched abstract of the article."'
